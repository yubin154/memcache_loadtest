...
final class SpyMemcachedAsciiTestStandalone extends SpyMemcachedBaseTest {

  SpyMemcachedAsciiTestStandalone(String server, int port, String version) {
    super(server, port, version, true);
  }
  ...
  private void testAppend() throws Exception {
    ...
    // casid ignored in ascii
    cas = client.gets(key);
    expectTrue(client.append(1L, key, valueToAppend).get(), "append");
  ...
  public void testIncr() throws Exception {
    String key = randomKey();
    // incr nonexist
    expectTrue(client.incr(key, 1) == -1, "incr noreply");
  ...
  public void testDecr() throws Exception {
    String key = randomKey();
    // decr nonexist
    expectTrue(client.decr(key, 1) == -1, "decr noreply");
  ...
  public void testFlush() throws Exception {
    ...
    expectTrue(client.get(key) == null, "flush");
  }
  ...
  public void testPrepend() throws Exception {
    ...
    // prepend, casid is ignored in ascii
    cas = client.gets(key);
